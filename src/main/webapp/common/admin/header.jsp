			...
			<div class="drop-user">
				<button onclick="dropdownFunc()" class="btn-drop-user">
					<img class="img-user btn-user-element"
						src="../../assets/images/user.jpg" alt="" /> <span
						class="btn-user-element"><%=SecurityUtils.getPrincipal().getFullName()%></span> <i
						class="fas fa-chevron-down btn-user-element"></i>
				</button>
				<div id="drop" class="header-sub-nav">
					<a href="update-profile.html"><i class="fas fa-user-cog"></i> <span>Settings</span></a>
					<a href=""><i class="fas fa-sign-out-alt"></i> <span>Log
							out</span></a>
				</div>
				...
				<div id="mySidenav" class="sidenav">
					...
					<img class="img-user-sidenav" src="../../assets/images/user.jpg"
						alt="" /> <a href="update-profile.html"><i
						class="fas fa-user-cog"></i> <span>Settings</span></a> <a href=""><i
	...
	<div id="navigation" class="topnav">
		<ul id="nav">
			...
			<li class="dropres" onclick="dropRes()"><a href="#"> <i
				...
				<ul class="subnav">
					<li><a href="manage-account.html"><i
							class="fas fa-graduation-cap"></i> Manage Account</a></li>
					<li><a href="manage-major.html"><i
